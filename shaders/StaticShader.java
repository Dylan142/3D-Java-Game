...
public class StaticShader extends ShaderProgram {
	...
	private int location_canBeCoveredByShadow;
	...
	protected void getAllUniformLocations() {
		...
		location_canBeCoveredByShadow = super.getUniformLocation("canBeCoveredByShadow");
	}
	
	public void loadCanBeCoveredByShadow(boolean bool) {
		super.loadFloat(location_canBeCoveredByShadow, bool == true ? 1 : 0);
	}
	...
	public void loadLights(List<LightComponent> lights) {
		for(int i = 0; i < MAX_LIGHTS; i++) {
			if(i < lights.size()) {
