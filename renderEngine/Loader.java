...
public class Loader {
	...
	public int loadTexture(String fileName) {
		...
		try {
			texture = TextureLoader.getTexture("PNG", Class.class.getResourceAsStream("/res/png/" + fileName + ".png"));
			GL30.glGenerateMipmap(GL11.GL_TEXTURE_2D);
			GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_LINEAR_MIPMAP_LINEAR);
			GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL14.GL_TEXTURE_LOD_BIAS, 0);//-2.4
	...
	/*
	 * ORDER OF STRING[] OF CUBE MAP TEXTURES!!
	 * 
	 * Right Face
	 * Left Face
	 * Top Face
	...
	private TextureData decodeTextureFile(String fileName) {
		...
		try {
			InputStream in = Class.class.getResourceAsStream("/res/png/" + fileName + ".png");
